...
vid_cam = cv2.VideoCapture(0,cv2.CAP_DSHOW)  #Start video capturing

face_cascade = cv2.CascadeClassifier('F:/LockUnlock/lock/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
